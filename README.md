...
|                                                            | Analyzes Exchange on-premises IMAP4 and/or POP3 protocol logs across one or more servers and aggregates unique Server + Protocol + IP + User combinations, together with an access count per combination. Optionally also produces a consolidated User + access count view per protocol, across all servers.                                                              |
